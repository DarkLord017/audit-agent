...
- `SKILL.md`
- `references/slither.md` — commands verified against Slither 0.11.6 in the
  worker image
...
| **Adapted on** | 2026-08-30 |

`references/triage.md` keeps the seven brocards and their structure, and
rewrites the tests and examples for smart contracts — privileged-role
findings, ERC standard behaviour, unreachable internal functions.
...
The `solidity-auditor` skill in `../solidity-auditor/` is separate
third-party work under MIT — see its own `ATTRIBUTION.md`.
